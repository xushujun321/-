      ...
      <el-row type="flex" justify="center">
        <el-form ref="formData" label-width="120px" :model="formData" :rules="rules">
          ...
          <el-form-item label="期望离职时间" prop="exceptTime">
            <el-date-picker v-model="formData.exceptTime" type="date" placeholder="选择日期时间" />
          </el-form-item>
          <el-form-item label="离职原因" prop="reason">
            <el-input v-model="formData.reason" type="textarea" rows="3" placeholder="请输入内容" />
          </el-form-item>
          <el-form-item>
            <el-button size="small" @click="btnOK">提交</el-button>
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        exceptTime: [{ required: true, message: '请输入离职时间', trigger: 'blur' }],
